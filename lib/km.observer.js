  ...
  _createClass(Observer, [{
    ...
    value: function deploy() {
      ...
      return new Promise(function (resolve, reject) {
        if (_this.endpoint) {
          needle('get', _this.endpoint).then(_this._resolve(resolve)).catch(_this._reject(reject));
        }
      });
    }
  }, {
    key: '_resolve',
    value: function _resolve(response) {
      var _this2 = this;
      ...
      return function (resolve) {
        ...
        if (response.statusCode == 200) {
          if (_this2.format) {
            resolve(_this2._format(response.body, resolve, reject));
          } else {
            resolve(response.body);
          }
        } else {
          _this2._reject({ error: response.statusCode, response: response });
        }
      };
    }
  }, {
